...
// Applying-stage results. Mirrors ResultsPage's visual language and stateless
// ?d= encoding, but the researched range is the hero rather than a score.
...
function NextStepChoice({ encoded }) {
  ...
  function handleGetScript() {
    ...
    navigate(`/apply/proof${encoded ? `?d=${encoded}` : ""}`);
  }
